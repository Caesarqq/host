    ...
    <div v-if="authStore.user && !authStore.loading" class="profile-content">
      <div class="user-info">
        <div class="section">
          ...
          <div class="info-row">
            <span class="label">{{ authStore.user.role === 'charity' ? 'ОГРН' : 'Фамилия' }}:</span>
            <span class="value">{{ authStore.user.role === 'charity' ? (authStore.user.ogrn || 'Не указан') : (authStore.user.last_name || 'Не указана') }}</span>
          </div>
